...
import { createDeal, getDeals, getDealById, updateDeal, deleteDeal, getInvoice, createQuoteFromDeal } from "../controllers/dealController";
...
router.post("/:id/create-quote", requirePermission("finance:create"), createQuoteFromDeal);
