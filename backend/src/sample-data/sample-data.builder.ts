...
const ALL_PERMISSIONS = [
  ...
  'invoices:view', 'invoices:create', 'invoices:edit', 'invoices:delete', 'invoices:approve', 'invoices:pay',
  ...
  'vendor-bills:view', 'vendor-bills:create', 'vendor-bills:edit', 'vendor-bills:delete', 'vendor-bills:approve', 'vendor-bills:pay',
...
const MANAGER_PERMISSIONS = [
  ...
  'vendor-bills:view', 'vendor-bills:create', 'vendor-bills:edit', 'vendor-bills:approve', 'vendor-bills:pay',
