  ...
  const products = await Promise.all([
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        capacity: 80,
        location: "Rooftop",
        description: "Open-air rooftop for intimate events",
      },
    }),
    prisma.product.upsert({
      where: { id: "prod-003" },
      ...
      create: {
        ...
        description: "Private lounge for executive meetings",
      },
    }),
    prisma.product.upsert({
      where: { id: "prod-004" },
      ...
      create: {
        ...
        type: "service",
        description: "8-hour photo + video coverage",
      },
    }),
    prisma.product.upsert({
      where: { id: "prod-005" },
      ...
      create: {
        id: "prod-005",
        name: "Catering — Full Buffet",
        type: "service",
        description: "Per-head full buffet catering service",
      },
    }),
  ]);
  ...
  const quote1 = await prisma.quote.upsert({
    ...
    create: {
      ...
      items: {
        create: [
          {
            description: "Standard Hall rental (1 day)",
            quantity: 1,
            unitPrice: 45000,
            discount: 0,
            total: 45000,
          ...
          {
            description: "Full Buffet Catering (200 persons)",
            quantity: 200,
            unitPrice: 150,
            discount: 0,
            total: 30000,
  ...
  const quote2 = await prisma.quote.upsert({
    ...
    create: {
      ...
      items: {
        create: [
          {
            description: "Standard Hall rental (2 days)",
            quantity: 2,
            unitPrice: 45000,
            discount: 5,
            total: 85500,
          ...
          {
            description: "Rooftop Garden rental (1 day)",
            quantity: 1,
            unitPrice: 20000,
            discount: 0,
            total: 20000,
    ...
    create: {
      ...
      items: {
        create: [
          ...
          {
            description: "AV & Production Setup",
            quantity: 1,
            unitPrice: 10000,
            discount: 0,
            total: 10000,
    ...
    create: {
      ...
      items: {
        create: [
          ...
          {
            description: "Full Buffet Catering (60 persons)",
            quantity: 60,
            unitPrice: 150,
            discount: 0,
            total: 9000,
          ...
          {
            description: "Decoration Package",
            quantity: 1,
            unitPrice: 3000,
            discount: 0,
            total: 3000,
  ...
  await Promise.all([
    prisma.task.upsert({
      ...
      create: {
        ...
        description:
          "Include revised pricing for Standard Hall + Rooftop combo",
  ...
  await Promise.all([
    prisma.activity.upsert({
      ...
      create: {
        ...
        description:
          "Client called to inquire about wedding packages. Interested in June dates.",
        date: daysAgo(10),
    ...
    prisma.activity.upsert({
      ...
      create: {
        ...
        description:
          "Client visited the Standard Hall and VIP Lounge. Impressed by the space.",
        date: daysAgo(4),
        status: ActivityStatus.completed,
        linkedToId: deals[2].id,
        linkedModel: "Deal",
  ...
  await prisma.expenseReport.upsert({
    ...
    create: {
      ...
      expenses: {
        create: [
          {
            description: "New table linens",
            amount: 3600,
            date: daysAgo(1),
            category: "equipment",
            beneficiary: "Linen House",
          },
          {
            description: "Stage rental for corporate event",
            amount: 5000,
            date: new Date(),
            category: "equipment",
            beneficiary: "Stage Pro Egypt",
          },
        ],
      },
    },
  ...
  await Promise.all([
    prisma.note.upsert({
      ...
      create: {
        id: "note-001",
        content:
          "Client prefers evening events, avoid morning slots. Also wants halal catering only.",
        linkedToId: customers[1].id,
        linkedModel: "Customer",
        customerId: customers[1].id,
        createdById: manager.id,
    ...
    prisma.note.upsert({
      ...
      create: {
        id: "note-002",
        content:
          "Competitor quote was 20% lower. Consider discounting photography package to close.",
        linkedToId: deals[2].id,
        linkedModel: "Deal",
        dealId: deals[2].id,
        createdById: admin.id,
